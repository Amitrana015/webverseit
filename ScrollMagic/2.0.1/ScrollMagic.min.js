/*! ScrollMagic v2.0.1 | (c) 2015 Jan Paepke (@janpaepke) | license & info: http://janpaepke.github.io/ScrollMagic */ ! function(e, t) {
    "function" == typeof define && define.amd ? define(t) : "object" == typeof exports ? module.exports = t() : e.ScrollMagic = t()
}(this, function() {
    "use strict";
    var e = function() {};
    e.version = "2.0.1", e.Controller = function(n) {
        var i, o, s = "ScrollMagic.Controller",
            ...
            y = function() {
                u.refreshInterval > 0 && (o = window.setTimeout(T, u.refreshInterval))
            },
            E = function() {
    ...
    e.Controller.addOption = function(e, n) {
                ...
                if (x && o) {
                    ...
                    if (e || "DURING" !== u) {
                        var n = {
                            ...
                            i = r.css(x, "position") != n.position;
                        T.pushFollowers ? c.duration > 0 && ("AFTER" === u && 0 === parseFloat(r.css(T.spacer, "padding-top")) ? i = !0 : "BEFORE" === u && 0 === parseFloat(r.css(T.spacer, "padding-bottom")) && (i = !0)) : n[t.vertical ? "top" : "left"] = c.duration * f, r.css(x, n), i && C()
                    } else {
                        "fixed" != r.css(x, "position") && (r.css(x, {
                            position: "fixed"
                        }), C());
                        var s = r.get.offset(T.spacer, !0),
                            a = c.reverse || 0 === c.duration ? t.scrollPos - h.start : Math.round(f * c.duration * 10) / 10;
                        s[t.vertical ? "top" : "left"] += a, r.css(x, {
                            top: s.top,
                            left: s.left
                        })
                    }
            ...
            C = function() {
                if (x && o && T.inFlow) {
                    var e = "DURING" === u,
                        ...
                        s = {};
                    T.relSize.width || T.relSize.autoFullWidth ? e ? r.get.width(window) == r.get.width(T.spacer.parentNode) ? r.css(x, {
                        width: T.relSize.autoFullWidth ? "100%" : "inherit"
                    }) : r.css(x, {
                        width: r.get.width(T.spacer)
                    }) : r.css(x, {
                        width: "100%"
                    }) : (s["min-width"] = r.get.width(t ? x : n, !0, !0), s.width = e ? s["min-width"] : "auto"), T.relSize.height ? e ? r.get.height(window) == r.get.height(T.spacer.parentNode) ? r.css(x, {
                        height: "inherit"
                    }) : r.css(x, {
                        height: r.get.height(T.spacer)
                    }) : r.css(x, {
                        height: "100%"
                    }) : (s["min-height"] = r.get.height(t ? n : x, !0, !i), s.height = e ? s["min-height"] : "auto"), T.pushFollowers && (s["padding" + (t ? "Top" : "Left")] = c.duration * f, s["padding" + (t ? "Bottom" : "Right")] = c.duration * (1 - f)), r.css(T.spacer, s)
                }
            },
            L = function() {
                o && x && "DURING" === u && !o.info("isDocument") && R()
            },
            N = function() {
                o && x && "DURING" === u && ((T.relSize.width || T.relSize.autoFullWidth) && r.get.width(window) != r.get.width(T.spacer.parentNode) || T.relSize.height && r.get.height(window) != r.get.height(T.spacer.parentNode)) && C()
            },
            D = function(e) {
                o && x && "DURING" === u && !o.info("isDocument") && (e.preventDefault(), o.scrollTo(o.info("scrollPos") - (e[o.info("vertical") ? "wheelDeltaY" : "wheelDeltaX"] / 3 || 30 * -e.detail)))
            };
        this.setPin = function(e, t) {
            ...
            var a = "absolute" != r.css(x, "position"),
                c = r.css(x, o.concat(["display"])),
                u = r.css(x, ["width", "height"]);
            x.parentNode.style.display = i, !a && t.pushFollowers && (t.pushFollowers = !1);
            ...
            if (a || r.extend(h, r.css(x, ["width", "height"])), r.css(f, h), f.setAttribute(s, ""), r.addClass(f, t.spacerClass), T = {
                    spacer: f,
                    relSize: {
            ...
            return T.relSize.width && r.css(f, {
                ...
                bottom: "auto",
                right: "auto"
            }), (T.relSize.width || T.relSize.autoFullWidth) && r.css(x, {
                boxSizing: "border-box",
                mozBoxSizing: "border-box",
                webkitBoxSizing: "border-box"
            }), window.addEventListener("scroll", L), window.addEventListener("resize", L), window.addEventListener("resize", N), x.addEventListener("mousewheel", D), x.addEventListener("DOMMouseScroll", D), R(), l
            ...
            if (x) {
                if ("DURING" === u && R(!0), e || !o) {
                    ...
                    T.spacer.parentNode.insertBefore(t, T.spacer), T.spacer.parentNode.removeChild(T.spacer), x.parentNode.hasAttribute(s) || (r.css(x, x.___origStyle), delete x.___origStyle)
                }
                window.removeEventListener("scroll", L), window.removeEventListener("resize", L), window.removeEventListener("resize", N), x.removeEventListener("mousewheel", D), x.removeEventListener("DOMMouseScroll", D), x = void 0
            }
            return l
        };
        var O, A = [];
